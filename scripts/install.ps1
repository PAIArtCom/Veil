...
Write-Host "  1. Start Veil in the background: veil service install"
Write-Host "  2. Check it is running:          veil status"
Write-Host "  3. Configure your AI tool base URL:"
Write-Host "     Claude Code: http://127.0.0.1:8787"
Write-Host "     Codex CLI:   http://127.0.0.1:8787/v1"
Write-Host "     OpenRouter:  http://127.0.0.1:8787/veil/upstream=https://openrouter.ai/api/v1"
Write-Host ""
Write-Host "Guide: https://veil.paiart.com/#install"
